...
#ifndef CLASSOPTIONSTAB_H
#define CLASSOPTIONSTAB_H
 ...
 */
class ClassOptionsTab : public QWidget
{
public:
     ...
     */
    ClassOptionsTab(QWidget* pParent, ClassifierWidget* pWidget);

    /**
     * Constructor - observe and modify an OptionState structure
     */
    ClassOptionsTab(QWidget* pParent, Settings::OptionState *options );

    /**
     * destructor
     */
    virtual ~ClassOptionsTab();
