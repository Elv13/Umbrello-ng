...
ClassOptionsTab::ClassOptionsTab(QWidget* pParent, ClassifierWidget* pWidget)
        : QWidget( pParent )
{
    init();
...
ClassOptionsTab::ClassOptionsTab(QWidget* pParent, Settings::OptionState *options) : QWidget( pParent )
{
    init();
    m_options = options;
...
ClassOptionsTab::~ClassOptionsTab()
{
}
 ...
 */
void ClassOptionsTab::setupPage()
{
 ...
 */
void ClassOptionsTab::setupClassPageOption()
{
    int margin = fontMetrics().height();
 ...
 */
void ClassOptionsTab::updateUMLWidget()
{
    if (m_pWidget) {
        updateWidget();
    } else if (m_options) {
 ...
 */
void ClassOptionsTab::updateWidget()
{
 ...
 */
void ClassOptionsTab::updateOptionState()
{
